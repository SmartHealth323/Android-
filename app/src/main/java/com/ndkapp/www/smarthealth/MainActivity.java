            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId())
                {
                    ...
                    case R.id.nav_hosp:
                        ...
                        browserIntent.setData(Uri.parse("https://www.google.com/maps/search/hospitals+near+me/@-1.2933943,36.8535048,13z/data=!3m1!4b1"));
                    ...
                    case R.id.nav_doc:
                        ...
                        browserIntent.setData(Uri.parse("https://www.hls.co.ke/?page=directory"));
                        startActivity(browserIntent);
